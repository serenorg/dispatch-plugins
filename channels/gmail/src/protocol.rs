...
impl EmailPreset for Preset {
    const PLUGIN_ID: &'static str = "gmail";
    const PLATFORM: &'static str = "gmail";
    const DEFAULT_IMAP_HOST: Option<&'static str> = Some("imap.gmail.com");
    const DEFAULT_SMTP_HOST: Option<&'static str> = Some("smtp.gmail.com");
    const DEFAULT_SMTP_PORT: u16 = 465;
    const DEFAULT_IMAP_PASSWORD_ENV: &'static str = "GMAIL_APP_PASSWORD";
    const DEFAULT_SMTP_PASSWORD_ENV: &'static str = "GMAIL_APP_PASSWORD";
}
