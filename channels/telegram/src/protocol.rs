...
pub use proto::{
    ...
    StatusAcceptance, StatusFrame, StatusKind, ThreadingModel, plugin_error,
};
...
pub struct ChannelConfig {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub default_message_thread_id: Option<i64>,
    #[serde(default)]
...
pub fn capabilities() -> ChannelCapabilities {
    ChannelCapabilities {
        ...
        ingress_modes: vec![IngressMode::Webhook, IngressMode::Polling],
