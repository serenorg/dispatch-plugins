...
use protocol::{
    ...
    PluginResponse, StatusAcceptance, StatusFrame, StatusKind, capabilities, parse_jsonrpc_request,
...
fn channel_policy(config: &ChannelConfig) -> ChannelPolicy {
    ChannelPolicy {
        ...
        allowed_outbound_conversation_ids: config.allowed_chat_ids.clone(),
        activation: None,
        thread_policy: None,
